...
public class ClientApp {
	...
	public static void main(String[] args) {
		...
		//cr.add(Restrictions.eq("ejob","Manager"));
//		cr.add(Restrictions.gt("esal", 12000.00));
//		cr.add(Restrictions.between("esal", 10000.00, 18000.00));
		cr.add(Restrictions.ilike("ejob","A%"));
